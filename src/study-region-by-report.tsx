...
const StudyReportRegion = ({ type }: { type: 'status' | 'studyCenter' }) => {
  ...
  useEffect(() => {
    ...
    request.get('https://rdpb-2.appspot.com/report2/studyCenter/region/' + region).then(data => data.body)
...
export default StudyReportRegion